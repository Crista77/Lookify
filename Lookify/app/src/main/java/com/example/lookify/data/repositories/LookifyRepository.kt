...
class NotifyRepository(private val notifyDao: Notify_DAO) {
    ...
    suspend fun insert(n: Notify) = notifyDao.insert(n)
...
class NotifyReachedRepository(private val notifyReachedDao: Notify_Reached_DAO) {
    ...
    suspend fun insert(nr: Reached_Notify) = notifyReachedDao.insert(nr)
    suspend fun markAsRead(userId: Int, notificationId: Int) = notifyReachedDao.markAsRead(userId, notificationId)
    suspend fun deleteNotification(userId: Int, notificationId: Int) = notifyReachedDao.deleteNotification(userId, notificationId)
}
...
class FollowersRepository(private val followersDao: Followers_DAO) {
    ...
    suspend fun deleteFollower(followerId: Int, followedId: Int) = followersDao.deleteFollower(followerId, followedId)
}
